...
class HueAPI:
    ...
    def __init__(self, client_id, client_secret, refresh_token, bridge_id):
    ...
    def refresh_access_token(self):
        ...
        """ADD LOGIC HERE WHEN TOKEN IS REFRESHED TO UPDATE SECRET STORE"""
...
def trigger_notification(request):
    ...
    Called by Cloud Scheduler at scheduled times
    """
    try:
